#!/usr/bin/env python3
"""
Einfaches Beispiel-Skript für die Dual-Dataset SNP-Analyse.
"""
...
def main():
    ...
    dataset1_config = {
        'name': 'dataset1',
        'path': 'csv_datein/dataset1/',  # Pfad zu Ihren ersten CSV-Dateien
    ...
    dataset2_config = {
        'name': 'dataset2',
        'path': 'csv_datein/dataset2/',  # Pfad zu Ihren zweiten CSV-Dateien
        'pattern': '*.csv',  # Alle CSV-Dateien im Verzeichnis
        'sep': ';'
    }
    ...
    # Optional: Zugriff auf die Pipeline-Objekte für weitere Analysen
